  ...
  return (
    <Card className="shadow-sm hover:shadow-md transition-shadow">
      ...
      <CardContent className="space-y-4">
        ...
        {skills.length === 0 && <p className="text-slate-500 text-center py-8">Add your first skill to get started</p>}
      </CardContent>
    </Card>
  )
}
      ...
      <CardContent className="space-y-6">
        {experience.length === 0 ? (
          <div className="text-center py-8">
            <p className="text-slate-500">No work experience yet</p>
            <p className="text-sm text-slate-400">Add your first work experience</p>
          </div>
        ) : (
          experience.map((exp) => (
      ...
      <CardContent className="space-y-6">
        {projects.length === 0 ? (
          <div className="text-center py-8">
            ...
            <p className="text-sm text-slate-400">Showcase your projects</p>
          </div>
        ) : (
          projects.map((proj) => (
            <div key={proj.id} className="pb-6 border-b border-slate-200 last:border-b-0 last:pb-0 group">
              <div className="flex justify-between items-start mb-3">
                ...
                <div className="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                  ...
                  <Button size="sm" variant="ghost" onClick={() => removeProject(proj.id)}>
                    <Trash2 size={16} className="text-red-500" />
                  </Button>
                </div>
              </div>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-start gap-3">
            <CheckCircle size={18} className="text-green-600 flex-shrink-0 mt-0.5" />
            <div>
              <p className="text-sm font-medium text-slate-900">Skills Added</p>
            </div>
          </div>
          <div className="flex items-start gap-3">
    ...
    <Card className="shadow-sm hover:shadow-md transition-shadow">
      ...
      <CardContent className="space-y-4">
        {cvUploaded ? (
          ...
          <>
            <div className="border-2 border-dashed border-slate-300 rounded-lg p-8 text-center bg-slate-50 hover:border-blue-600 transition-colors">
              <Upload size={32} className="mx-auto mb-3 text-slate-400" />
              <p className="text-slate-900 font-medium">Drop your CV here or click to browse</p>
    ...
    <Card className="shadow-sm hover:shadow-md transition-shadow">
      <CardHeader>
        <div className="space-y-1">
          ...
          <CardDescription className="text-xs">From your CV</CardDescription>
        </div>
      </CardHeader>
      <CardContent>
        <div className="flex flex-wrap gap-2">
        ...
        <p className="text-xs text-slate-600 mt-4">These skills were found in your CV</p>
      </CardContent>
    </Card>
  )
}
  ...
  return (
    <Card className="shadow-sm hover:shadow-md transition-shadow bg-blue-50 border-blue-200">
      ...
      <CardContent className="space-y-3">
        ...
        <div className="flex gap-3">
          <div className="w-1.5 h-1.5 rounded-full bg-blue-600 mt-2 flex-shrink-0" />
          <p className="text-sm text-slate-900">Add 2-3 personal projects</p>
        </div>

        <button className="text-sm text-blue-600 hover:text-blue-700 font-medium pt-2">Dismiss</button>
      </CardContent>
    </Card>
  )
}
      ...
      <div className="sticky top-0 z-10 bg-white border-b border-slate-200 shadow-sm">
        <div className="max-w-7xl mx-auto px-6 py-8">
          <div className="space-y-4">
            ...
            <p className="text-slate-600">Complete your profile to improve your matching accuracy</p>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-slate-500">
                {100 - completion === 0
                  ? 'Profile complete!'
                  : `Add ${Math.ceil((100 - completion) / 25)} more sections to reach 100%`}
              </p>
            </div>
          </div>
        </div>
